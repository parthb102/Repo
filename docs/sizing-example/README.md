...
`ds-sizing-example.pptx` is a two-slide illustrative walkthrough of the sizing method:
...
- **Slide 2** — backup: the assumptions behind every number, meant to be replaced with a real role's data before reuse.
